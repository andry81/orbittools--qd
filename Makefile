...
DIST_COMMON = README $(am__configure_deps) $(dist_doc_DATA) \
	...
	$(srcdir)/qd-config.in $(top_srcdir)/configure \
	$(top_srcdir)/include/qd/qd_config.h.in AUTHORS COPYING \
...
am__aclocal_m4_deps = $(top_srcdir)/m4/ax_cxx_clock_gettime.m4 \
	...
	$(top_srcdir)/m4/ax_fc_etime.m4 $(top_srcdir)/m4/libtool.m4 \
...
CONFIG_HEADER = config.h $(top_builddir)/include/qd/qd_config.h
CONFIG_CLEAN_FILES = qd-config
...
FC = pgf95
FCFLAGS = -O2 -Mfree 
FCLIBS =  -L/opt/pgi/linux86-64/17.9/lib -L/usr/lib64 -L/usr/lib/gcc/x86_64-redhat-linux/4.8.5 -L/usr/lib/gcc/x86_64-redhat-linux/4.8.5/../../../../lib64 -lpgf90rtl -lpgf90 -lpgf90_rpm1 -lpgf902 -lpgftnrtl -lpgmp -lnuma -lpthread -lnspgc -lpgc -lrt -lm 
FFLAGS = -O2 -Mfree 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/Owner/hipreclibs/QD/qd-2.3.20/config/missing --run makeinfo
...
STRIP = strip
VERSION = 2.3.20
abs_builddir = /home/Owner/hipreclibs/QD/qd-2.3.20
abs_srcdir = /home/Owner/hipreclibs/QD/qd-2.3.20
abs_top_builddir = /home/Owner/hipreclibs/QD/qd-2.3.20
abs_top_srcdir = /home/Owner/hipreclibs/QD/qd-2.3.20
ac_ct_CC = c++
ac_ct_CXX = c++
ac_ct_DUMPBIN = 
ac_ct_FC = pgf95
...
install_sh = ${SHELL} /home/Owner/hipreclibs/QD/qd-2.3.20/config/install-sh
...
include/qd/qd_config.h: include/qd/stamp-h2
	@if test ! -f $@; then \
	  rm -f include/qd/stamp-h2; \
	  $(MAKE) $(AM_MAKEFLAGS) include/qd/stamp-h2; \
	else :; fi

include/qd/stamp-h2: $(top_srcdir)/include/qd/qd_config.h.in $(top_builddir)/config.status
	@rm -f include/qd/stamp-h2
	cd $(top_builddir) && $(SHELL) ./config.status include/qd/qd_config.h

distclean-hdr:
	-rm -f config.h stamp-h1 include/qd/qd_config.h include/qd/stamp-h2
qd-config: $(top_builddir)/config.status $(srcdir)/qd-config.in
